...
//    @RequestMapping(value = "/library-observations/update", method = RequestMethod.PUT)
...
//    }
    ...
    @RequestMapping(value = "/book-checkouts/{id}", method = RequestMethod.PATCH, consumes = MediaType.APPLICATION_JSON_VALUE)
