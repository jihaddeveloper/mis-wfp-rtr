...
public class PLFObservation extends BaseEntity {
    ...
    @Column(name = "ind11_is_carried_all_material_note", length = 300)
    ...
    @Column(name = "ind12_is_checked_in_right_time_note", length = 300)
    ...
    @Column(name = "ind13_is_observed_bangla_library_note", length = 300)
    ...
    @Column(name = "ind14_feedback_session_with_teacher_note", length = 300)
    ...
    @Column(name = "ind15_meeting_with_head_teacher_note", length = 300)
    ...
    @Column(name = "ind16_filled_all_form_properly_note", length = 300)
    ...
    @Column(name = "ind17_observed_class_silently_note", length = 300)
    ...
    @Column(name = "ind21_lf_teacher_maintain_good_relationship_note", length = 300)
    ...
    @Column(name = "ind22_lf_discuss_good_practice_indicator_note", length = 300)
    ...
    @Column(name = "ind23_lf_discuss_coaching_support_indicator_note", length = 300)
    ...
    @Column(name = "ind24_lf_discuss_last_followup_indicator_note", length = 300)
    ...
    @Column(name = "ind25_lf_instruct_ideal_lesson_note", length = 300)
    ...
    @Column(name = "ind26_lf_observe_student_or_group_note", length = 300)
    ...
    @Column(name = "ind27_lf_verify_workbook_note", length = 300)
    ...
    @Column(name = "ind28_lf_track_3_student_note", length = 300)
    ...
    @Column(name = "ind29_lf_teacher_agreed_next_plan_note", length = 300)
    ...
    @Column(name = "ind31_lf_identify_good_improvable_point_note", length = 300)
    ...
    @Column(name = "ind32_lf_instruct_development_plan_note", length = 300)
    ...
    @Column(name = "ind33_lf_discuss_about_development_plan_note", length = 300)
    ...
    @Column(name = "ind34_lf_allow_to_change_teaching_pattern_note", length = 300)
    ...
    @Column(name = "ind35_lf_allow_teacher_for_discussion_note", length = 300)
    ...
    @Column(name = "best_practice_indicator1_details", length = 300)
    ...
    @Column(name = "best_practice_indicator2_details", length = 300)
    ...
    @Column(name = "best_practice_indicator3_details", length = 300)
    ...
    @Column(name = "coaching_support_indicator1_details", length = 300)
    ...
    @Column(name = "coaching_support_indicator2_details", length = 300)
    private String coachingSupportIndicator2Details;


    @Column(name = "coaching_support_lf", length = 600)
    private String coachingSupportLF;
    @Column(name = "coaching_support_lpo", length = 600)
